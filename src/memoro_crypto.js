 ...
 * @returns {Uint8Array}
 */
export function aes_gcm_encrypt(key_bytes, nonce_bytes, plaintext) {
    const ptr0 = passArray8ToWasm0(key_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(nonce_bytes, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passArray8ToWasm0(plaintext, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.aes_gcm_encrypt(ptr0, len0, ptr1, len1, ptr2, len2);
    if (ret[3]) {
 ...
 * @returns {Uint8Array}
 */
export function aes_gcm_decrypt(key_bytes, nonce_bytes, ciphertext) {
    const ptr0 = passArray8ToWasm0(key_bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(nonce_bytes, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    ...
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.aes_gcm_decrypt(ptr0, len0, ptr1, len1, ptr2, len2);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v4 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('memoro_crypto_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
